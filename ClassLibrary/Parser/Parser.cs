...
public class Parser
{
    ...
    public object ParseExpression()
    {
        ...
        if (expressionResult is string && (currentToken.Kind == TokenKind.Addition || currentToken.Kind == TokenKind.Substraction || currentToken.Kind == TokenKind.Multiplication || currentToken.Kind == TokenKind.Division || currentToken.Kind == TokenKind.Power))
        {
    ...
    private object ParseComparison()
    {
        ...
        else
        {
            ...
            if (!IsABooleanOperator(_operator))
            {
                return leftExpression;
            }
    ...
    private object ParseSum()
    {
        ...
        else
        {
            ...
            while (currentToken.Kind == TokenKind.Addition || currentToken.Kind == TokenKind.Substraction)
            {
                ...
                if (operatorToken.Kind == TokenKind.Addition && rightExpression is double)
                {
                    leftExpression += (double)rightExpression;
                }

                else if (operatorToken.Kind == TokenKind.Substraction && rightExpression is double)
                {
                    leftExpression -= (double)rightExpression;
                }
    ...
    private object ParseFactor()
    {
        ...
        else
        {
            ...
            while (currentToken.Kind == TokenKind.Multiplication || currentToken.Kind == TokenKind.Division || currentToken.Kind == TokenKind.Modulus)
            {
                Token operatorToken = currentToken;
                Consume(1);
                ...
                if (operatorToken.Kind == TokenKind.Multiplication && nextToken is double)
                    _factor *= (double)nextToken;

                else if (operatorToken.Kind == TokenKind.Division && nextToken is double)
                    _factor /= (double)nextToken;
    ...
    private object ParsePower()
    {
        ...
        else
        {
            ...
            while (currentToken.Kind == TokenKind.Power)
            {
                Token operatorToken = currentToken;
                Consume(1);
                object rightExpression = ParseTerm();
    ...
    bool IsABooleanOperator(TokenKind _operator)
    {
    ...
    private void CreateVar()
    {
        ...
        Consume(1);
        if (currentToken.Kind != TokenKind.Number && currentToken.Kind != TokenKind.String && currentToken.Kind != TokenKind.Identifier && currentToken.Kind != TokenKind.LeftParenthesis && currentToken.Kind != TokenKind.FalseKeyWord && currentToken.Kind != TokenKind.TrueKeyWord && currentToken.Kind != TokenKind.Substraction)
        {
