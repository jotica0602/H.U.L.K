...
{
    public Power(ExpressionKind kind, TokenKind operator_, Expression leftNode, Expression rightNode) :
    ...
    public override object? Evaluate(Scope scope) => Value = Math.Pow((double)LeftNode!.Evaluate(scope)! , (double)RightNode!.Evaluate(scope)!);
